...
// 0x0000006C TProvider UnityEngine.SubsystemsImplementation.Extensions.SubsystemExtensions::GetProvider(UnityEngine.SubsystemsImplementation.SubsystemWithProvider`3<TSubsystem,TDescriptor,TProvider>)
